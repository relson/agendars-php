...
function showrow($row, $recid) {
    ...
    <?php } ?></select>
        ...
        <tr>
            <td class="hr"><?php echo htmlspecialchars("Data de In�cio") . "&nbsp;" ?></td>
            <td class="dr"><input type="text" name="dataInicio" value="<?php echo str_replace('"', '&quot;', trim($row["dataInicio"])) ?>"></td>
        </tr>
        <tr>
            <td class="hr"><?php echo htmlspecialchars("Hora de In�cio") . "&nbsp;" ?></td>
        ...
        <tr>
            <td class="hr"><?php echo htmlspecialchars("T�tulo") . "&nbsp;" ?></td>
    ...
    <?php if ($page < $pagecount) { ?>
                <td>&nbsp;<a href="tarefa.php?page=<?php echo $page + 1 ?>">Pr�ximo&nbsp;&gt;&gt;</a>&nbsp;</td>
    <?php } ?>
        </tr>
    </table>
<?php } ?>
...
function showrecnav($a, $recid, $count) {
    ...
    <table class="bd" border="0" cellspacing="1" cellpadding="4">
        ...
        <?php } if ($recid < $count - 1) { ?>
                <td><a href="tarefa.php?a=<?php echo $a ?>&recid=<?php echo $recid + 1 ?>">Pr�ximo Registro</a></td>
        <?php } ?>
        </tr>
    </table>
    <hr size="1" noshade>
